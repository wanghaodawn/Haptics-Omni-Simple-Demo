...
/******************************************************************
		A box with a sphere inside

		User Guide	--> by Hao Wang 2014.07
******************************************************************/
...
const double sphereRadius = 60.0;		// The radius of the Sphere
const double sphereStiffness = 0.25;		// The Stiffness of the Sphere
#define SphereX	0	// X parameter of Sphere
#define SphereY	80	// Y parameter of Sphere (Height)
#define SphereZ	0	// Z parameter of Sphere
/********************************************************/
//void mainLoop();
