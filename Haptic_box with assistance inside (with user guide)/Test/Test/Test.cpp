...
/*************************************************************
	A box with assistance inside
	--> Finished by Hao wang 2014.07
*************************************************************/
...
static HDdouble gSpringStiffness = 0.7;	// Set the assistance value in the space
/***************************************************************/
/***************************************************************/


hduVector3Dd position0;			//Former position of Mouse
...
/********************************************************************************************************/
	if(position[0] >= -EdgeX && position[0] <= EdgeX && position[1] >= EdgeY && position[2] >= -EdgeZ && position[2] <= EdgeZ)
	{
		...
		hduVector3Dd F;
		hduVector3Dd Distances;
		int keypress;

		hduVecSubtract(Distances, position, position0);	//两者相减，产生阻力
		F = Distances * stiffness;
		hdSetDoublev(HD_CURRENT_FORCE, F);
