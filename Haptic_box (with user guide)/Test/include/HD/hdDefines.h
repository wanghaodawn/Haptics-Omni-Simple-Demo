...
{      
    ...
    HHD hHD; /* The handle of the current device when the error occurred */ //错误发生后的解决方法     
} HDErrorInfo;      
/* Boolean */      
#define HD_TRUE                           1      
#define HD_FALSE                          0      
...
/* 硬件属性 Device hardware properties */      
...
/* 设备力量与管理 Device forces and measurements. */      
...
/* 直角坐标空间值 Cartesian space values */      
...
/* 当前值不可用 *****HD_CURRENT_MOTOR_DAC_VALUES is deprecated,      
...
/* 上一个值不可用 *****HD_LAST_MOTOR_DAC_VALUES is deprecated,      
 ...
 *****************************************************************************/      
/*****************************************************************************      
 * 使能或禁止能力 Enable/Disable capabilities                                               */      
...
/*****************************************************************************      
 * 其它参数 Miscellaneous                                                             */      
/* 调度器优先级范围 Scheduler priority ranges */      
...
/* 设备不可操作 Null device handle */      
#define HD_INVALID_HANDLE                  0xFFFFFFFF      
/* 此处应该用于设备初始化 Used by device initialization. */      
#define HD_DEFAULT_DEVICE                  NULL      
/* LED状态灯状态 LED status light states */      
